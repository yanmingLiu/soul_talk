...
import 'package:soul_talk/presentation/ap/cc002/v/conv_list_view.dart';
import 'package:soul_talk/presentation/ap/cc002/v/fllow_list_view.dart';
          ...
          children: [
            ...
            Expanded(
              child: PageView(
                ...
                children: [
                  KeepAliveWrapper(child: ConvListView(controller: chatCtr)),
